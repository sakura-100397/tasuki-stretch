    ...
    return `
      <div class="menu-shell">
        ...
        <nav class="nav" aria-label="ページナビゲーション">
          ...
          <a href="https://lin.ee/ys3Z9mR" target="_blank" rel="noopener noreferrer">問合せ</a>
          <a class="nav-cta" href="https://reserva.be/tasukistretch/reserve?mode=service_staff&search_evt_no=13eJwzNTa3MDIHAARiAUE" target="_blank" rel="noopener noreferrer">無料体験申込み</a>
        </nav>
      </div>
    `;
  }
